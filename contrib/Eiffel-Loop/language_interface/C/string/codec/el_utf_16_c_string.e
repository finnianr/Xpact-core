...
--					ascii_count := c_utf_16_to_ascii (
--						ptr + i * 2, (i_final - i + 1).min (remaining_count), dest.item_address (j)
--					)
	...
	copy_as_utf_8_X (dest: SPECIAL [CHARACTER]; dest_index, n: INTEGER)
		local
			dest_full, partial_pair: BOOLEAN; ptr: POINTER
...
feature {NONE} -- Implementation
	...
	utf_16_to_ascii (src: POINTER; unit_count: INTEGER; dest: SPECIAL [CHARACTER]; dest_index: INTEGER): INTEGER
...
feature {NONE} -- Constants
	...
	Non_ascii_mask: NATURAL_64 = 0xFF80FF80FF80FF80
